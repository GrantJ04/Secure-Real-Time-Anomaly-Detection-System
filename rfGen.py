...
def simRFwithPAnomalies(nSignals): #simulates a real/accurate RF signal with the ability to control the number of signals
    ...
    for signal in range(nSignals):
        ...
        randPHS.append(np.random.uniform(0, np.pi * 2))
    ...
    for point in points:
        ...
        if randS < 0.01: #1% chance for a spike to occur
